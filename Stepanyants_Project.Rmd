...
Гипотезы подтвердились лишь частично. Для дальнейшего развития исследования (насколько это возможно) полезно было бы увеличить объёмы выборок (самое понятное - взять ещё два доступных  Евангелия), учесть данные о переводчиках, проверить разметку. Для более правильной лингвистической интерпретации нужно привлекать данные из непереводных текстов. Можно ещё использовать Точный тест Фишера (таблички сопряжённости маленькие) или Cramer's V. Базовые сравнения вроде частотности осложнены необходимостью разметки на двух языках (важны конкретные функции).